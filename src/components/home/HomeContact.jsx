...
export default function HomeContact() {
  ...
  return (
    <footer className="home-sheet home-contact" id="contact" tabIndex={-1} ref={root} aria-labelledby="home-contact-title">
      ...
      <div className="home-contact-links"><a className="home-contact-email" href={`mailto:${profile.email}`}>{profile.email} <span aria-hidden="true">↗︎</span></a>
        <div className="home-contact-socials"><a className="home-text-link" href={profile.github} target="_blank" rel="noreferrer">GitHub ↗︎</a><a className="home-text-link" href={profile.linkedin} target="_blank" rel="noreferrer">LinkedIn ↗︎</a><a className="home-text-link" href={profile.resume} target="_blank" rel="noreferrer">Resume ↗︎</a><Link className="home-text-link" to="/gallery">Gallery ↗︎</Link></div>
      </div>
