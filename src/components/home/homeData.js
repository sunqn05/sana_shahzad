export const profile = {
  ...
  linkedin: 'https://www.linkedin.com/in/sana-shahzad-01726328b',
...
export const experience = [
  {
    ...
    description: 'Making complex coding concepts approachable through hands-on, project-based learning.',
